...
namespace CaptainPinkTurd.Core.Algorithm.AStar.Tiles 
{
    public abstract class NodeBase : MonoBehaviour 
    {
        ...
        public bool Occupied { get; private set; } //occupied are used for something temporary
        ...
        public bool SetOccupied(bool occupied) => Occupied = occupied;
        ...
        public abstract void CacheNeighbors(GridManager gridManager);
