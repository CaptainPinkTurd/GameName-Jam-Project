...
namespace CaptainPinkTurd.Core.Extensions
{
    public static class Vector2Extensions 
    {
        ...
        public static Vector2 MultiplyVector2D(this Vector2 vector, Vector2 multiplier)
        {
            return new Vector3(vector.x * multiplier.x, vector.y * multiplier.y);
        }
        /// <summary>
        ...
        public static Quaternion ToRotation2D(this Vector2 direction, float zOffsetDegrees = 0)
        {
